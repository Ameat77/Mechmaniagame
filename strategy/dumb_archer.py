...
class DumbArcher(Strategy):
    ...
    def use_action_decision(self, game_state: GameState, my_player_index: int) -> bool:
        ...
        if (player_list[my_player_index].item == Item.STRENGTH_POTION and position in center):
            prediction_dic = DumbArcher.everyones_moves(game_state, my_player_index)
    ...
    def everyones_moves(game_state: GameState, my_player_index: int):
        ...
        moves = DumbArcher.possible_moves(position[0], position[1], speed)
        ...
        for i in range(4):
            if i != my_player_index:
                ...
                if their_position in center:
                    ...
                    if item_stats == "Item.HUNTER_SCOPE":
                        their_range += 1
                    their_moves = DumbArcher.possible_moves(their_position[0], their_position[1], their_speed)
                    their_best_move = DumbArcher.most_central(their_moves)
